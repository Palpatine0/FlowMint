    ...
    <div className="max-w-2xl mx-auto" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm" style={{ padding: "24px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px", marginBottom: "24px" }}>
          <div style={{ position: "relative" }}>
            {draft.avatarUrl ? (
              <img
                src={draft.avatarUrl}
                alt="Avatar"
                style={{ width: "72px", height: "72px", borderRadius: "50%", objectFit: "cover", border: "3px solid #76DDAA" }}
              />
            ) : (
              <div
                style={{
          ...
          <div style={{ flex: 1 }}>
            <p className="text-sm font-medium text-slate-700 dark:text-slate-300" style={{ marginBottom: "8px" }}>
              Choose an avatar
            </p>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              {THEME_OPTIONS.map((opt) => (
                <button
                  key={opt.value}
                  onClick={() => { update("theme", opt.value); onThemeChange(opt.value); }}
